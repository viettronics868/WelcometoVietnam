...
import com.khoanam.bubbleshoot.game.engine.Layer;
import com.khoanam.bubbleshoot.game.engine.Scene;
import com.khoanam.bubbleshoot.game.engine.Sprite;
import com.khoanam.bubbleshoot.game.engine.SurfaceViewHandler;
import com.khoanam.bubbleshoot.game.engine.TextSprite;
...
//		System.out.println("LevelSelectMenu.selected = " + LevelSelectMenu.selected);
	    ...
	    if(false){
	        ...
	        background= BitmapFactory.decodeResource(resources, R.drawable.menubackground);
	    }
